...
for (const route of [...routes, '/robots.txt', '/sitemap.xml', '/style.css', '/editorial.css', '/local.css', '/modern.css', '/proposal-b.css', '/site.js', '/config.js', '/logo.png', '/pcsoft-partner.png', '/migration-architecture.png', '/migration-gold-light.png', '/migration-code.png', ...fontFiles]) {
  try {
